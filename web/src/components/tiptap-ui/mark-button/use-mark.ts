...
// Kite: only the marks markdown can spell. Underline, superscript and
// subscript would be dropped on save, so they are not offered.
...
const markLabels: Record<Mark, Key> = {
  bold: "editor.bold",
