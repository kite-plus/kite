...
// MDN has the guide in both of the admin's languages.
const regexDocs = (locale: string) =>
  `https://developer.mozilla.org/${locale === "zh-CN" ? "zh-CN" : "en-US"}` +
  "/docs/Web/JavaScript/Guide/Regular_expressions"

const REGEX_SEARCH_EXAMPLES: { label: Key; pattern: string }[] = [
  { label: "editor.search.anyLetter", pattern: "c.t" },
  { label: "editor.search.eitherTerm", pattern: "cat|tiptap" },
  { label: "editor.search.eitherCase", pattern: "[Cc]at" },
]
            ...
            <ButtonGroup className="button-group" orientation="horizontal">
              <ButtonGroup>
                <Button
                  ...
                  tooltip={t("editor.search.previous")}
            ...
            <div className="tiptap-search-replace-inputs">
              ...
              <InputGroup className="tiptap-search-replace-input-group">
                <InputGroupInput
                  ...
                  placeholder={t("editor.search.replaceWith")}
                  aria-label={t("editor.search.replaceWith")}
                  value={replaceTerm}
                  autoComplete="off"
                  autoCorrect="off"
                  autoCapitalize="off"
                ...
                <div className="tiptap-search-replace-regex-help-section">
                  ...
                  >
                    {REGEX_REPLACE_EXAMPLES.map(({ pattern, replacement }) => (
                      ...
                      >
                        <code>{pattern}</code> {t("editor.search.to")}{" "}
                  ...
                  <a
                    ...
                    href={regexDocs(locale)}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {t("editor.search.learnRegex")}
                    <ExternalLinkIcon
