...
export interface paths {
    "/account": {
        ...
        /** Describe the person using the studio and how they sign in. */
    ...
    "/account/avatar": {
        ...
        /** Read the picture shown beside the name. */
        get: operations["getAvatar"];
        /** Choose the picture: PNG, JPEG, GIF or WebP, up to 1 MB. */
    ...
    "/account/credentials": {
        ...
        get?: never;
        /** Give a studio with no password one, or change the name and password of a guarded one. A change ends every other session; the caller's is issued again in Set-Cookie. */
        put: operations["setCredentials"];
        post?: never;
        /** Take the password away, leaving the studio open. Only a server that listens on this machine alone allows it. */
        delete: operations["removeCredentials"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/account/profile": {
        ...
        get?: never;
        /** Change the name and email address the studio shows. They are kept in .kite/secrets, never published. */
    ...
    "/account/sessions": {
        ...
        put?: never;
        post?: never;
        /** Sign out every browser but the caller's, whose session is issued again in Set-Cookie. */
    ...
    "/export": {
        ...
        get?: never;
        put?: never;
        /** Build the site as a deployment gets it, without drafts, and answer with it as a zip archive of what kite build writes, to upload anywhere that serves static files. */
        post: operations["exportSite"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/plugins/{id}/enabled": {
        ...
        get?: never;
        /** Turn a plugin on, to run after the ones already on, or off. It changes plugins.enabled by one; one that cannot load is not turned on. */
        put: operations["switchPlugin"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
...
export interface operations {
    getAccount: {
        ...
        requestBody?: never;
        responses: {
            /** @description The account and profile. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    switchPlugin: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PluginSwitch"];
            };
        };
        responses: {
            /** @description The plugin as it now is. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
