...
export const en = {
  ...
  "setup.tokenHelp": "Printed on the server's console when it started. With Docker: docker compose logs kite",
  "setup.user": "User name",
  "setup.password": "Password",
  "setup.passwordHelp": "At least {n} characters. Length is all that is asked for.",
  "setup.passwordShort": "At least {n} characters.",
  ...
  "problem.bad_setup_token": "That is not the setup token for this server.",
